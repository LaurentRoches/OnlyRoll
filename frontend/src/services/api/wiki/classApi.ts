...
import type { PaginatedWikiResponse, ClassListItem, ClassDetail, SubclassDetail, WikiFilters } from '@/types/wiki'

export const classApi = {
  async getClasses(filters: WikiFilters = {}): Promise<PaginatedWikiResponse<ClassListItem>> {
    return get<PaginatedWikiResponse<ClassListItem>>(`/wiki/classes${buildWikiQuery(filters as Record<string, string | number | undefined>)}`)
  },
